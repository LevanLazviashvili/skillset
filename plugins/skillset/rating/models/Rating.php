...
//    protected $fillable = ['order_id', 'rated_id', 'rater_id'];
    ...
    public $belongsTo = [
        'RatedUser'         => [User::class, 'key' => 'rated_id', 'otherKey' => 'id', 'conditions' => 'status_id = 1 AND admin_user_id is null'],
        'RaterUser'         => [User::class, 'key' => 'rater_id', 'otherKey' => 'id', 'conditions' => 'status_id = 1 AND admin_user_id is null'],
        'Order'             => [Order::class],
