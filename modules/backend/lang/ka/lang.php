...
return [
    ...
    'list' => [
        ...
        'pagination' => 'ჩანაწერები: :from-:to, ჯამური: :total-დან',
        ...
        'delete_selected_confirm' => 'დარწმუნებული ხართ რომ გსურთ მონიშნული ჩანაწერების წაშლა?',
        'delete_selected_success' => 'Deleted selected records.',
        'column_switch_true' => 'კი',
        'column_switch_false' => 'არა',
    ],
    'fileupload' => [
    ...
    'form' => [
        ...
        'confirm_delete_multiple' => 'დარწმუნებული ხართ რომ გსურთ ჩანაწერების წაშლა?',
        ...
        'return_to_list' => 'ჩანაწერებში დაბრუნება',
    ],
    'recordfinder' => [
    ...
    'reorder' => [
        'default_title' => 'თანმიმდევრობის შეცვლა',
    ...
    'import_export' => [
        ...
        'export_output_format' => '1. აირჩიეთ ექსპორტის ტიპი',
        'file_format' => 'ფაილის ტიპი',
        'standard_format' => 'სტანდარტული ფორმატი',
        'custom_format' => 'ჩემი ფორმატი',
        'delimiter_char' => 'Delimiter character',
        'enclosure_char' => 'Enclosure character',
        'escape_char' => 'Escape character',
        'select_columns' => '2. აირჩიეთ რა ველების ექსპორტი გსურთ',
        'column' => 'Column',
        'columns' => 'ველები',
        ...
        'processing_successful_line1' => 'ფაილების ექსპორტი წარმატებით დასრულდა!',
        'processing_successful_line2' => 'ექსელის ფაილი დაემატა თქვენს გადმოწერებში',
        'export_progress' => 'ექსპორტის შედეგი',
